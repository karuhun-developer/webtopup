...
import {
    ...
    destroy,
    edit,
} from '@/actions/App/Http/Controllers/Cms/Web/SliderController';
...
defineProps<{
    data: PaginationItem<SliderDataItem>;
    orderBy?: string;
    order?: 'asc' | 'desc';
    search?: string;
    paginate?: number;
...
const title = 'Slider';
const description =
    'Manage sliders to be displayed on the website homepage. You can create, edit, and delete sliders as needed.';
