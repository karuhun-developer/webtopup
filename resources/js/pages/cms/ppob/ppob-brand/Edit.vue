...
const serverList = ref<string[]>(
    props.brand.settings?.servers ? props.brand.settings.servers : [],
);
        ...
        <div class="p-6">
            ...
            >
                ...
                <div class="grid gap-2">
                    ...
                    <Select
                        name="provider"
                        :default-value="brand.provider || 'digiflazz'"
                    >
                ...
                <div class="grid gap-2">
                    ...
                    <ImageUploadPreview
                        ...
                        :initial-preview="brand.default_product_image"
                    />
                </div>
                ...
                <div class="grid grid-cols-1 gap-2 md:grid-cols-2 md:gap-6">
                    <div class="grid gap-2">
                        ...
                        <Select
                            name="featured"
                            :default-value="brand.featured ? '1' : '0'"
                        >
                ...
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        required
                        autofocus
                        :default-value="brand.settings?.label_id || 'ID'"
                    />
                ...
                <div class="grid gap-2" v-if="settingsType === 'id+server'">
                    ...
                    <Input
                        ...
                        autofocus
                        :default-value="
                            brand.settings?.label_server || 'Server'
                        "
                    />
